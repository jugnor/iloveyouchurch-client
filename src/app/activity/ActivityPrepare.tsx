...
export const activityRowsRendererByType = (
  data: ResultsObject<Activity> | undefined,
  methode: string
) => {
...
export const upsertActivityFormData = (
  params: GridRenderCellParams,
  activityType: string
) => {
  const activityOrder: string =
    '' + params.getValue(params.id, 'activityOrder');
...
export const validateActivity = (upsertActivity: {}): boolean => {
  ...
  return (
    ...
    !UpsertActivityRequestSchema.validate(upsertActivity).error
  );
};
