...
export const postboxRowsRenderer = (
  data: ResultsObject<PostboxModel> | undefined,
  methode: string
) => {
...
export const upsertPostboxFormData = (params: GridRenderCellParams) => {
...
export const validatePostbox = (
  upsertPostbox: {},
  create: boolean
): boolean => {
  if (create) {
    return (
      upsertPostbox !== undefined &&
      !CreatePostboxRequestSchema.validate(upsertPostbox).error
    );
  }
  ...
  return (
    upsertPostbox !== undefined &&
    !UpdatePostboxRequestSchema.validate(upsertPostbox).error
  );
};
