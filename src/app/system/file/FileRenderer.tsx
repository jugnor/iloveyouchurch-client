...
export const fileRowsRenderer = (data: ResultsObject<FileModel> | undefined, methode: string) => {
...
export const validateUpsertFile = (upsertUserFile: {}): boolean => {
  ...
  return upsertUserFile !== undefined && !UpdateFileRequestSchema.validate(upsertUserFile).error
}
...
export const fileColumns = (): GridColumns => [
  ...
  {
    field: 'size', headerName: 'Länge',
    editable: false, resizable: true, width: 200
  },
  {
    field: 'createdAt', headerName: 'Erstellt_Am',
    editable: false, resizable: true, width: 200
  }];
