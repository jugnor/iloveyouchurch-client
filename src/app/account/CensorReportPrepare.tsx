...
export const accountRowsRendererByWeek = (
  data: ResultsObject<Account> | undefined,
  startWeek: string,
  methode: string
) => {
  ...
  if (
    ...
    if (data !== undefined) {
      resultMap = data.items.map((x) => ({
        ...
        week:
          'von ' +
          toDate(Date.parse(x.startWeek)).toLocaleDateString() +
          ' bis ' +
          toDate(Date.parse(x.endWeek)).toLocaleDateString()
      }));
    }
  }
