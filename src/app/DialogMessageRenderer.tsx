...
interface DialogMessageRendererProps {
  ...
  params: any
  handleDeleteClick: (params: GridRenderCellParams) => (event: { stopPropagation: () => void; }) => void
}

export function DialogMessageRenderer({
                                        openDialog, setOpenDialog, params, handleDeleteClick
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            Willst du wirklich die Daten löschen? Es besteht keine Möglichkeit mehr die gelöschten
