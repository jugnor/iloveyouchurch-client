...
import { UserRecap } from './UserTab/UserRecap';
import { RegulationBoard } from './RegulationTab/RegulationBoard';
...
export interface LeaderTabPanelProps {
  groupName: string;
  userId: string;
}
export default function LeaderTabPanel({
  groupName,
  userId
}: LeaderTabPanelProps) {
