...
export function HomeTabPanel({ postboxId }: HomeTabPanelProps) {
      ...
      <div className={classes.root}>
        <AppBar position="static" color="transparent">
          ...
          <TabPanel value={value} index={0}>
            <ActivityRecap postboxId={postboxId} />
          </TabPanel>
          <TabPanel value={value} index={1}>
            <RegulationRecap postboxId={postboxId} />
          </TabPanel>
          <TabPanel value={value} index={2}>
            <FileRecap postboxId={postboxId} />
          </TabPanel>
        </AppBar>
      </div>
    </Suspense>
