...
export function PrayerInputField(prayerInputFieldProps: PrayerInputFieldProps) {
  const [min, setMin] = useState(prayerInputFieldProps.prayer?.timeInMinute);
  const [pNight, setPNight] = useState(
    prayerInputFieldProps.prayer?.prayerNight
  );
    ...
    >
      ...
      <div>
        ...
        <TextField
          ...
          value={
            prayerInputFieldProps.prayer === undefined
              ? ''
              : new Date(
