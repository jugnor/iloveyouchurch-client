...
export function GospelInputForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      gospelContact:
      {
          name: gospel?.gospelContact.name,
          email: gospel?.gospelContact.email,
          telephone: gospel?.gospelContact.telephone,
          city: gospel?.gospelContact.city
        },
      gospelSupport: {
        title: gospel?.gospelSupport.title,
        supportType: gospel?.gospelSupport.supportType
      },
                  ...
                  render={({ field }) => {
                    return (
                      ...
                      <TextField
                        ...
                        error={errors.gospelContact?.name?.message !== undefined}
                        onBlur={field.onBlur}
                        required={true}
                        onChange={field.onChange}
                        id="name"
                      ...
                      return (
                        <Stack>
                          <TextField
                            ...
                            error={errors.gospelSupport?.title?.message !== undefined}
                            onBlur={field.onBlur}
                            required={true}
                            onChange={field.onChange}
