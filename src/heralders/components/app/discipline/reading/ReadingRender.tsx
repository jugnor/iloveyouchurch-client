...
import {Reading, UpsertReadingRequestSchema} from "../../../../models/Reading";
...
export const upsertReadingFormData = (start: string, end: string, create: boolean, params: GridRenderCellParams) => {
  ...
  if (oId === undefined || oId === '') {
    ...
    export const validateReading = (upsertReading:{}):boolean => {
      return upsertReading !== undefined && !UpsertReadingRequestSchema.validate(upsertReading).error
    }
